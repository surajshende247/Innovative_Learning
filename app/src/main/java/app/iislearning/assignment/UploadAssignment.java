...
public class UploadAssignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("We will evaluate your assignment soon...");
                ...
                new Response.Listener<NetworkResponse>() {
                    ...
                    public void onResponse(NetworkResponse response) {
                        ...
                        try {
                            ...
                            Toast.makeText(UploadAssignment.this.getApplicationContext(), "UPLOAD", Toast.LENGTH_SHORT).show();
                           // Log.d("UPLOAD","SUCCESS");
                            Intent intent = new Intent(UploadAssignment.this,AllAssignments.class);
                            startActivity(intent);
